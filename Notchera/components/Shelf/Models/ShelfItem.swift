...
enum ShelfItemKind: Codable, Equatable {
    ...
    init(from decoder: Decoder) throws {
        ...
        case .text:
            self = try .text(string: container.decode(String.self, forKey: .value))
        case .link:
            self = try .link(url: container.decode(URL.self, forKey: .value))
        }
    }
...
private extension ShelfItem {
    static func thumbnailSymbolImage(
        ...
        symbolColor _: NSColor = NSColor.labelColor
    ) -> NSImage? {
