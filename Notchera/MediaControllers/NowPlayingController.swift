...
final class NowPlayingController: ObservableObject, MediaControllerProtocol {
    ...
    private func handleAdapterUpdate(_ update: NowPlayingUpdate) async {
        ...
        newPlaybackState.title = payload.title ?? (diff ? playbackState.title : "")
        newPlaybackState.artist = payload.artist ?? (diff ? playbackState.artist : "")
...
actor JSONLinesPipeHandler {
    ...
    private func processJSONLine<T: Decodable>(_ line: String, as _: T.Type, onLine: @escaping (T) async -> Void) async {
